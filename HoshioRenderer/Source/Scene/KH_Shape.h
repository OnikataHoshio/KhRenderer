...
public:
    ...
    virtual void EncodePrimitives(
        ...
        KH_ShaderFeatureType ShaderFeatureType = KH_ShaderFeatureType::DisneyBRDF) const = 0;
...
public:
    ...
    static bool CmpxPtr(const std::unique_ptr<KH_Primitive>& p1, const std::unique_ptr<KH_Primitive>& p2);
    static bool CmpyPtr(const std::unique_ptr<KH_Primitive>& p1, const std::unique_ptr<KH_Primitive>& p2);
    static bool CmpzPtr(const std::unique_ptr<KH_Primitive>& p1, const std::unique_ptr<KH_Primitive>& p2);

protected:
    KH_PrimitiveType PrimitiveType = KH_PrimitiveType::Triangle;
